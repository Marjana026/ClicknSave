    ...
    const linkSections = [
        ...
        },
        {
            ...
            links: [
                ...
                { text: "Offer your deals", path: '/create-store', icon: null },
            ]
        },
        {
            title: "CONTACT",
            links: [
                { text: "+880-1609257680", path: '/', icon: MailIcon },
                ...
                <div className="flex flex-col md:flex-row items-start justify-between gap-10 py-10 border-b border-slate-500/30 text-slate-500">
                    <div>
                        <Link href="/" className="text-4xl font-semibold text-slate-700">
                            <span className="text-green-600">clickN</span>save<span className="text-green-600 text-5xl leading-0">.</span>
                        </Link>
                        <p className="max-w-[410px] mt-6 text-sm">Welcome to clickNsave, your ultimate destination for the latest and smartest deals. From food and clothes to essential accessories, we bring you the best in prices — all in one place.</p>
